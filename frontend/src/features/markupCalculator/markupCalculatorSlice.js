...
const API_URL_NAME = 'markup-calculations';
...
export const markupCalculatorSlice = createSlice({
	name: 'markupCalculatorSlice',
	initialState,
	reducers: {
		reset: () => initialState,
...
export const { reset, closeCalculation } = markupCalculatorSlice.actions;
export default markupCalculatorSlice.reducer;

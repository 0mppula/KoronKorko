...
const API_URL = '/api/present-value-calculations/';
const API_URL_NAME = 'present-value-calculations';
...
export const presentValueCalculatorSlice = createSlice({
...
export const { reset, closeCalculation } = presentValueCalculatorSlice.actions;
export default presentValueCalculatorSlice.reducer;

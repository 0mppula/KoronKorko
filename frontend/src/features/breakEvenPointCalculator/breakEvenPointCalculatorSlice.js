...
const API_URL = '/api/break-even-point-calculations/';
const API_URL_NAME = 'break-even-point-calculations';
...
export const breakEvenPointCalculatorSlice = createSlice({
	name: 'breakEvenPointCalculator',
	initialState,
	reducers: {
		reset: () => initialState,
...
export const { reset, closeCalculation } = breakEvenPointCalculatorSlice.actions;
export default breakEvenPointCalculatorSlice.reducer;
